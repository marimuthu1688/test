...
(function(window, angular, undefined) {'use strict';
  ...
  function $RouteProvider(){
     ...
     *    - `controllerAs` тАУ `{string=}` тАУ A controller alias name. If present the controller will be
     *      published to scope under the `controllerAs` name.
     *    - `template` тАУ `{string=|function()=}` тАУ html template as a string or a function that
